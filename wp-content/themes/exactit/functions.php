...
function mytheme_load_scripts()
{
    ...
    // Enqueue ScrollTrigger plugin from CDN
    ...
    // Enqueue your theme's main JS file and make sure it depends on GSAP and ScrollTrigger
    wp_enqueue_script('js-script', get_theme_file_uri('/src/js/main.js'), array('gsap', 'scrolltrigger'), null, true);
}
